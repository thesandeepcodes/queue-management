...
export default function QrCodes() {
    ...
    return fetchingEvent ? (
        ...
        <div>
            ...
            {
                events.length == 0 && (
                    <div className="border min-h-[200px] flex items-center justify-center border-neutral-800 select-none transition-colors rounded-md p-4 bg-neutral-900/50 text-neutral-500">
                        No events found.
                    </div>
                )
            }
